...
*   0xFF, the function will increment the red fieled by 1 for each structure in 
*   the array.  
*
...
*   0x00, the function will decrement the red field by 1 for each structure in 
*   the array.  
*
*   If the direction is decrementing and the value of the red field is equal to
